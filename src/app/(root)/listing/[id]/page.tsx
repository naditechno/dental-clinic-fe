    ...
    <main>
      ...
      >
        <div className="px-4 md:px-10 xl:container xl:mx-auto">
          ...
          <div className="mt-[30px] grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-x-5">
            <div className="col-span-2 xl:col-span-3 space-y-5 pr-0 md:pr-[50px]">
              ...
              <div className="flex flex-wrap items-center gap-3 md:space-x-[30px]">
      ...
      <section
        ...
        className="px-4 md:px-10 xl:container xl:mx-auto py-[50px] flex flex-col md:flex-row space-y-8 md:space-x-8 xl:space-x-[80px]"
      >
        <div className="w-full max-w-full md:max-w-[600px] xl:max-w-[650px] space-y-[30px]">
          <Title
            section="detail"
            title="About House"
